    ...
    def INPUT_TYPES(cls):
        ...
        return {
            "required": {
                ...
                "denoise": ("FLOAT", {"default": 0.3, "min": 0.0, "max": 1.0, "step": 0.01, "tooltip": "Lower values preserve more of the original upscaled image."}),
                "positive_prompt": ("STRING", {"multiline": True, "default": "photorealistic, high detail, sharp focus, skin texture"}),
                "negative_prompt": ("STRING", {"multiline": True, "default": "blurry, low quality, distorted, cartoon"}),
                "steps": ("INT", {"default": 20, "min": 1, "max": 10000}),
                "cfg": ("FLOAT", {"default": 1.0, "min": 0.0, "max": 100.0, "step": 0.1}),
                "sampler_name": (comfy.samplers.KSampler.SAMPLERS, ),
                "scheduler": (comfy.samplers.KSampler.SCHEDULERS, ),
                "seed": ("INT", {"default": 0, "min": 0, "max": 0xffffffffffffffff}),
                "vae_tiling": (["enabled", "disabled"], {"default": "enabled", "tooltip": "Essential for high-res upscales (2K+). Prevents OOM by decoding in tiles."}),
            }
        }
